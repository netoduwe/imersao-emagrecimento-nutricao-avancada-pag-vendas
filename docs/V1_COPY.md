# Rota: `/imersao-5ed` (Página de Vendas V1 — Verde)
...
- **Botão de Ação (CTA):** `VER OPÇÕES DE INGRESSO`
- **Pílula de Preço no Hero:**
  - Lote: `LOTE ZERO`
  - Valor: `A partir de R$ 19,90`
  - Método: `ou Pix · Opção VIP disponível com Gravação`
- **Linha de Segurança:** `Garantia de 7 dias · Sem burocracia`
- **Pílula de Urgência Inferior:** `• Vendas abertas · Lote zero ativo · Vagas limitadas por sala •`
...
- **Linha do Tempo (Cronograma):**
  - **09h00 (Ney Felipe) — Emagrecimento Além das Calorias:**
  ...
  - **13h00 (Jéssica Wszolek) — Manejo dietético no uso dos análogos de GLP-1:**
  ...
  - **17h00 (Ney & Jéssica) — Casos Clínicos e Perguntas ao Vivo:**
...
## 7. Seção: Depoimentos (Resultados)
- **Título:** `O que dizem quem já esteve lá`
...
## 10. CTA Final
- **Título:** `Sua próxima consulta de emagrecimento pode ser diferente.`
- **Subtítulo:** `Garanta seu ingresso no Lote Zero antes que o preço suba.`
- **Botão:** `ESCOLHER MEU INGRESSO`
- **Segurança:** `Garantia de 7 dias · Pagamento seguro · Acesso imediato`
